    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                success: function(msg) {
                    $('#nama_pengeluaran').val(msg.nama_pengeluaran);
                    $('#tanggal_pengeluaran').val(msg.tanggal_pengeluaran);
                    $('#nominal_pengeluaran').val(msg.nominal_pengeluaran);
                }
            });
        });
