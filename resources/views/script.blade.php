    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                success: function(msg) {
                    $('#nama_pemasukan').val(msg.nama_pemasukan);
                    $('#tanggal_pemasukan').val(msg.tanggal_pemasukan);
                    $('#nominal_pemasukan').val(msg.nominal_pemasukan);
                }
            });
        });
