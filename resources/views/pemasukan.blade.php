...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0 font-weight-bold">Data Pemasukan</h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel-2">Pemasukan</h5>
                ...
                <form id="form-tambah">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nominal_pemasukan" class="form-control" required>
                        </div>
                        <div class="form-group">
                ...
                <form id="form-edit">
                    <div class="modal-body">                    
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_pemasukan" id="nama_pemasukan" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Nominal pemasukan:</label>
